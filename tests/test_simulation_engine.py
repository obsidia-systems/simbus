...
class TestTickHolding:
    ...
    def test_register_without_simulation_not_updated(self) -> None:
        cfg = _minimal_config({"holding": [{"address": 0, "name": "manual", "default": 50.0, "scale": 1}]})
        store = RegisterStore()
        store.initialize(cfg.registers)
        engine = SimulationEngine(store=store, config=cfg)
        engine._tick(1.0)
                ...
                "input": [
                    {
                        ...
                        "default": 30.0,
                        "scale": 100,
                        "simulation": {"behavior": "sinusoidal", "period_hours": 1, "amplitude": 5.0},
                    }
                ]
            }
        )
...
class TestAlarmEvaluation:
    def test_coil_set_when_threshold_exceeded(self) -> None:
        cfg = _minimal_config(
            {
                "holding": [
                    {"address": 0, "name": "temp", "default": 35.0, "scale": 10, "simulation": {"behavior": "constant"}}
                ],
                "coils": [
                    {
                        "address": 0,
                        "name": "high_temp",
                        "default": False,
                        "trigger": {"source_register": "temp", "condition": "gt", "threshold": 30.0},
                    }
                ],
            }
        )
    ...
    def test_coil_cleared_when_below_threshold(self) -> None:
        cfg = _minimal_config(
            {
                "holding": [
                    {"address": 0, "name": "temp", "default": 20.0, "scale": 10, "simulation": {"behavior": "constant"}}
                ],
                "coils": [
                    {
                        "address": 0,
    ...
    def test_discrete_trigger_uses_set_discrete(self) -> None:
        ...
        cfg = _minimal_config(
            {
                "holding": [
                    {"address": 0, "name": "level", "default": 90.0, "scale": 1, "simulation": {"behavior": "constant"}}
                ],
                "discrete": [
                    {
                        "address": 0,
                        "name": "overflow",
                        "default": False,
                        "trigger": {"source_register": "level", "condition": "gt", "threshold": 80.0},
                    }
                ],
            }
        )
