...
5. Open the PR against **`develop`**, not `main`. The PR gate is the **CI**
   workflow (same five commands). Release (`dist`) and GHCR do not run on
   PRs; a `v*` tag on `main` publishes.
